...
// Переключатель языка и метки страниц продублированы в /assets/js/nav.js:
// этот файл режут блокировщики рекламы (списки против cookie-баннеров), а
// повторный запуск безопасен. Держим в обоих файлах, пока у посетителей в
// кеше может оставаться старая копия nav.js.
